package com.Louay.vateldl2.dataLayer;
...
import com.Louay.vateldl2.logicLayer.Customer;
import com.Louay.vateldl2.logicLayer.HRS;
import com.Louay.vateldl2.logicLayer.Hotel;
import com.Louay.vateldl2.logicLayer.Reservation;
import com.Louay.vateldl2.logicLayer.Room;
import com.Louay.vateldl2.logicLayer.Vendor;
import com.Louay.vateldl2.presentationLayer.MyDBHelper;
import com.Louay.vateldl2.presentationLayer.Reservations_Store;
...
public class writerAndReader {
    Context context;
    String directoryUrl = "http://192.168.43.39/PHP%20Servers/PHP_Files/";  // Your computer's IP address with URL-encoded spaces
    
    public writerAndReader(Context context) {
        this.context = context;
    }

    public void insertCustomerDataIntoServer(Customer customer, @Nullable Uri dp, VolleyCallBack volleyCallBack) {
        // Skip image upload and directly insert customer data with empty image URL
        customer.setDp("");
        insertCustomerIntoServer(customer, "", volleyCallBack);
                ...
                new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        try {
                            ...
                            if (object.has("reqcode") && object.getInt("reqcode") == 1) {
                                volleyCallBack.onSuccess();
                            } else {
                                String msg = object.has("reqmsg") ? object.getString("reqmsg") : "Registration failed";
    ...
    public void getCustomersFromServer(Vector<Customer> customers) {
        ...
        Volley.newRequestQueue(context).add(request);
    }    public void insertVendorDataIntoServer(Vendor vendor, @Nullable Uri dp, VolleyCallBack volleyCallBack) {
        // Always skip image upload and directly insert vendor data with empty image URL
        vendor.setDp("");
        insertVendorIntoServer(vendor, "", volleyCallBack);
